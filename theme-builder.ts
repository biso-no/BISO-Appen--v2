...
const palettes = {
    ...
    ,
      "light_accent": ['hsla(0, 0%, 82%, 1)','hsla(212, 100%, 40%, 0)','hsla(212, 100%, 40%, 0.25)','hsla(212, 100%, 40%, 0.5)','hsla(212, 100%, 40%, 0.75)','hsla(212, 100%, 40%, 1)','hsla(212, 100%, 43%, 1)','hsla(212, 100%, 46%, 1)','hsla(212, 100%, 48%, 1)','hsla(212, 100%, 51%, 1)','hsla(212, 100%, 54%, 1)','hsla(212, 100%, 57%, 1)','hsla(212, 100%, 59%, 1)','hsla(212, 100%, 62%, 1)','hsla(212, 100%, 65%, 1)','hsla(250, 50%, 95%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(0, 0%, 55%, 1)']
    ,
