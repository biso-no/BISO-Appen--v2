...
const palettes = {
      ...
      "light": ['hsla(204, 100%, 59%, 1)','hsla(0, 0%, 99%, 0)','hsla(0, 0%, 99%, 0.25)','hsla(0, 0%, 99%, 0.5)','hsla(0, 0%, 99%, 0.75)','hsla(0, 0%, 99%, 1)','hsla(0, 0%, 93%, 1)','hsla(0, 0%, 88%, 1)','hsla(0, 0%, 82%, 1)','hsla(0, 0%, 77%, 1)','hsla(0, 0%, 72%, 1)','hsla(0, 0%, 66%, 1)','hsla(0, 0%, 61%, 1)','hsla(0, 0%, 55%, 1)','hsla(0, 0%, 50%, 1)','hsla(0, 15%, 15%, 1)','hsla(0, 15%, 10%, 1)','hsla(0, 14%, 10%, 0.75)','hsla(0, 14%, 10%, 0.5)','hsla(0, 14%, 10%, 0.25)','hsla(0, 14%, 10%, 0)','hsla(211, 100%, 64%, 1)']
    ,
      "dark": ['hsla(212, 100%, 54%, 1)','hsla(0, 0%, 0%, 0)','hsla(0, 0%, 0%, 0.25)','hsla(0, 0%, 0%, 0.5)','hsla(0, 0%, 0%, 0.75)','hsla(0, 0%, 0%, 1)','hsla(0, 0%, 6%, 1)','hsla(0, 0%, 11%, 1)','hsla(0, 0%, 17%, 1)','hsla(0, 0%, 22%, 1)','hsla(0, 0%, 28%, 1)','hsla(0, 0%, 33%, 1)','hsla(0, 0%, 39%, 1)','hsla(0, 0%, 44%, 1)','hsla(0, 0%, 50%, 1)','hsla(0, 15%, 93%, 1)','hsla(0, 15%, 95%, 1)','hsla(0, 15%, 95%, 0.75)','hsla(0, 15%, 95%, 0.5)','hsla(0, 15%, 95%, 0.25)','hsla(0, 15%, 95%, 0)','hsla(212, 100%, 26%, 1)']
    ,
      "light_accent": ['hsla(0, 0%, 82%, 1)','hsla(200, 100%, 56%, 0)','hsla(200, 100%, 56%, 0.25)','hsla(200, 100%, 56%, 0.5)','hsla(200, 100%, 56%, 0.75)','hsla(200, 100%, 56%, 1)','hsla(202, 100%, 57%, 1)','hsla(203, 100%, 58%, 1)','hsla(204, 100%, 59%, 1)','hsla(205, 100%, 60%, 1)','hsla(207, 100%, 61%, 1)','hsla(208, 100%, 62%, 1)','hsla(209, 100%, 63%, 1)','hsla(211, 100%, 64%, 1)','hsla(212, 100%, 65%, 1)','hsla(250, 50%, 95%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(0, 0%, 55%, 1)']
    ,
      "dark_accent": ['hsla(0, 0%, 44%, 1)','hsla(212, 100%, 10%, 0)','hsla(212, 100%, 10%, 0.25)','hsla(212, 100%, 10%, 0.5)','hsla(212, 100%, 10%, 0.75)','hsla(212, 100%, 10%, 1)','hsla(212, 100%, 15%, 1)','hsla(212, 100%, 21%, 1)','hsla(212, 100%, 26%, 1)','hsla(212, 100%, 32%, 1)','hsla(212, 100%, 38%, 1)','hsla(212, 100%, 43%, 1)','hsla(212, 100%, 49%, 1)','hsla(212, 100%, 54%, 1)','hsla(212, 100%, 60%, 1)','hsla(250, 50%, 90%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(0, 0%, 17%, 1)']
